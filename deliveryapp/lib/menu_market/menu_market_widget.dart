...
import 'menu_market_model.dart';
export 'menu_market_model.dart';

class MenuMarketWidget extends StatefulWidget {
  const MenuMarketWidget({super.key});

  @override
  State<MenuMarketWidget> createState() => _MenuMarketWidgetState();
}

class _MenuMarketWidgetState extends State<MenuMarketWidget> {
  late MenuMarketModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MenuMarketModel());
