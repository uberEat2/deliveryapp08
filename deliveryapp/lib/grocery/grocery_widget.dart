...
class GroceryWidget extends StatefulWidget {
  ...
  final DocumentReference? grocery;
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<RestaurantsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<RestaurantsRecord> groceryRestaurantsRecordList = snapshot.data!;
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Builder(
                      builder: (context) {
                        final grocery = groceryRestaurantsRecordList.toList();
                        return ListView.separated(
                          ...
                          itemBuilder: (context, groceryIndex) {
                            final groceryItem = grocery[groceryIndex];
                            return Padding(
                              padding: const EdgeInsetsDirectional.fromSTEB(
                                  0.0, 16.0, 0.0, 16.0),
                              child: InkWell(
                                ...
                                onTap: () async {
                                  context.pushNamed(
                                    'restaurants_detail',
                                    queryParameters: {
                                      'restaurantsRef': serializeParam(
                                        groceryRestaurantsRecordList
                                            .first.reference,
                  ...
                  Flexible(
                    child: Builder(
                      builder: (context) {
                        final groceryRef = _model.simpleSearchResults.toList();
                        return ListView.builder(
                          ...
                          shrinkWrap: true,
                          scrollDirection: Axis.vertical,
                          itemCount: groceryRef.length,
                          itemBuilder: (context, groceryRefIndex) {
                            final groceryRefItem = groceryRef[groceryRefIndex];
                            return InkWell(
                              splashColor: Colors.transparent,
                              focusColor: Colors.transparent,
                              hoverColor: Colors.transparent,
