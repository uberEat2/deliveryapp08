  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      FFAppState().addToCart(CartItemTypeStruct(
        quantity: 1,
        specialInstructions: FFAppState().cart.first.specialInstructions,
        item: FFAppState().cart.first.item,
      ));
                                                      ...
                                                      padding:
                                                          const EdgeInsetsDirectional
                                                              .fromSTEB(
                                                                  ...
                                                                  0.0),
                                                      child: Text(
                                                        cartItemItem.specialInstructions,
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                                .labelLarge
