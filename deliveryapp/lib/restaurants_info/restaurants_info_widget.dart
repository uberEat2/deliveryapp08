                    ...
                    children: [
                      Flexible(
                        child: FlutterFlowStaticMap(
                          ...
                          apiKey:
                              'pk.eyJ1IjoianVsaW9icyIsImEiOiJjbHRhaWEzbGgwNTcxMmlxNm9nYm8zYjNhIn0.ciqpHN_OcJ0vP1Vtc2YMBw',
                        ...
                        children: [
                          Padding(
                            padding: const EdgeInsetsDirectional.fromSTEB(
                                0.0, 0.0, 0.0, 5.0),
                            child: Text(
                              'Open until${dateTimeFormat('Hm', restaurantsInfoRestaurantsRecord.close)}',
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                                    fontFamily: 'Readex Pro',
                          ...
                          Padding(
                            ...
                            child: StreamBuilder<List<ReviewRecord>>(
                              stream: queryReviewRecord(
                                parent:
                                    restaurantsInfoRestaurantsRecord.reference,
                              ),
                              builder: (context, snapshot) {
                                // Customize what your widget looks like when it's loading.
                                if (!snapshot.hasData) {
                                ...
                                List<ReviewRecord> textReviewRecordList =
                                    snapshot.data!;
                                return Text(
                                  '⭐(${functions.getAverageRating(textReviewRecordList.map((e) => e.rating).toList()).toString()})(${textReviewRecordList.length.toString()})',
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                                        fontFamily: 'Readex Pro',
